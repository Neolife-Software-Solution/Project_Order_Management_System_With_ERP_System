 ...
 * @author Hash_Boy
 */
public class DiningMenuOrder extends javax.swing.JDialog {

    /**
     * Creates new form Dining_Menu_Order
     */
    public DiningMenuOrder(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Person1RadioButton.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        Person1RadioButton.setText("1 Person");

        buttonGroup1.add(Person2RadioButton);
        Person2RadioButton.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DiningMenuOrder dialog = new DiningMenuOrder(new javax.swing.JFrame(), true);
