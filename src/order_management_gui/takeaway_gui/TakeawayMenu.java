 ...
 * @author Hash_Boy
 */
public class TakeawayMenu extends javax.swing.JDialog {

    /**
     * Creates new form Dining
     */
    public TakeawayMenu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TakeawayMenu dialog = new TakeawayMenu(new javax.swing.JFrame(), true);
