 ...
 * @author 2003k
 */
public class TakeawaySelectPortion extends javax.swing.JDialog {

    /**
     * Creates new form SelectPortion
     */
    public TakeawaySelectPortion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TakeawaySelectPortion dialog = new TakeawaySelectPortion(new javax.swing.JFrame(), true);
