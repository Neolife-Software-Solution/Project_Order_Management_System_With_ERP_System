...
public class EmployeeAddress extends javax.swing.JDialog {
    ...
    private void loadProvince() {
        ...
        try {
            ...
            provinceArrayList.add("Select Province");
            ...
            while (provinceResultSet.next()) {
                ...
                provinceArrayList.add(provinceResultSet.getString("province_name"));
            ...
            for (String province : provinceArrayList) {
    ...
    private void loadDistricts(String province) {
        ...
        try {
            ...
            while (districtResultSet.next()) {
                ...
                districtArrayList.add(districtResultSet.getString("district_name"));
            ...
            for (String district : districtArrayList) {
    ...
    private void loadCities(String district) {
        ...
        try {
            ...
            cityArrayList.add("Select City");  // Add default option
            ...
            while (cityResultSet.next()) {
                ...
                cityArrayList.add(cityResultSet.getString("city_name"));
        ...
        try {
            ...
            if (cityinput.isEmpty() || cityinput.equals("New City")) {
                ...
                if (!lastSavedCity.isEmpty()) {
                    ...
                    String query = "INSERT INTO `city` (`city_name` , `district_district_id`) VALUES ('" + cityinput + "' , '" + districtindex + "')";
                ...
                addPlaceholder(); // Reset cityTextField
    ...
    private void submitAddress() {
        ...
        try {
            ...
            String provinceId = String.valueOf(provinceComboBox.getSelectedIndex());
            String districtId = String.valueOf(districtComboBox.getSelectedIndex());
            String cityId = String.valueOf(cityComboBox.getSelectedIndex());
