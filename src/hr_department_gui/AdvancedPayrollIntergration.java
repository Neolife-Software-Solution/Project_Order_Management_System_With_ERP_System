...
public class AdvancedPayrollIntergration extends javax.swing.JDialog {
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        try {
            ...
            String payrollid = PayrollIDTextfield.getText(); //Select payroll id textfield
            String employeeid = EmployeeIDTextfield.getText(); //Select employee id textfield
            String employeename = EmployeeNameTextfield.getText(); //Select employee name textfield
            String amount = AdvanceAmountTextfield.getText(); //Select adavnced amount textfield

            // Check if the payroll id is empty
            if (payrollid.isEmpty() || payrollid.equals("Enter Payroll ID")) {
                ...
                //Check if the advanced amount is empty
                ...
                try {
                    double parsedAmount = Double.parseDouble(amount); // Check if the amount is a valid number
                    if (parsedAmount <= 0) {
                    ...
                    //Insert new payment
                    MySql.executeUpdate("INSERT INTO `advanced_payroll` (`employee_employee_id`,`employee_name`,`date`,`advanced_price`) VALUES ('" + employeeid + "','" + employeename + "','" + formattedDate + "','" + amount + "')");

                    //load to table
                    loadAdvancedPay();
                    reset();// Clear the text field for the next entry

                    //focus on the payroll id textfield again aftr adding the Advanced payment
